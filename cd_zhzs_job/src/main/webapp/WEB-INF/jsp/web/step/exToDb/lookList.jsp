...
<form id="pagerForm" method="post"
	action="${basePath}web/excel/importEx/lookList">
	...
	<form id="pagerForm" rel="pagerForm" method="post"
		...
		<div class="searchBar">
			<ul class="searchContent">
				<li><label>表名称：</label> <input type="text" name="name"
					value="${tableName }" /></li>
				<dd>
	...
	<table class="table" width="100%" layoutH="85" targetType="dialog">
		...
		<tbody>
			<c:forEach var="list" items="${pageList.result}" varStatus="status">
				<tr
					ondblclick="javascript:$.bringBack({'table_id':'${list.tableName}','tableName':'${list.tableName}'});TxtChange();">
					<td align="center"><input name="choseValue" type="checkbox"
						value="${list.tableName}@@${list.tableName }"></td>
