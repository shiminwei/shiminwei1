	...
	<form method="post"  name="searchForm"  id="searchForm"
		...
		<div class="searchBar">
			<ul class="searchContent">
				<li><label >用户名：</label> <input style="margin-left:-30px" type="text" name="userName" value="${sysReportUser.userName }" /></li>
				<li style="margin-left:-50px"><label>登录帐号：</label> <input style="margin-left:-20px" type="text" name="userCode" value="${sysReportUser.userCode }" /></li>
