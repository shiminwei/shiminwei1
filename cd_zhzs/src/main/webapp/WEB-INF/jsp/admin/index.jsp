...
<![endif]-->
		...
		<script type="text/javascript">
			$(function() {
				...
				if ($("#divCurPage").html() == '') {
					navTab.init();
					navTab.openTab('departmentList',
							'${basePath }admin/department/show', {
								title : '组织机构管理',
								fresh : true,
								data : {}
							});
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="${basePath }admin/department/show"
								target="navTab" rel="departmentList">组织机构管理</a></li>
							<li><a href="${basePath }admin/department/showAreaList"
								target="navTab" rel="areaManager">地区管理</a></li>
							<li><a
								href="${basePath }admin/department/showAreaDepartmentList?type=1"
								target="navTab" rel="areaDepartmentManager">地区&nbsp;---&nbsp;组织机构管理</a></li>
						</ul>
					</div>
					<div class="accordionHeader">
						<h2>
			...
			<div id="navTab" class="tabsPage">
				<div class="tabsPageHeader">
					<div class="tabsPageHeaderContent">
						...
						<ul class="navTab-tab">
							<li tabid="departmentList" class="main"><a
								href="javascript:;"><span><span class="home_icon">组织机构管理</span></span></a></li>
						</ul>
					</div>
