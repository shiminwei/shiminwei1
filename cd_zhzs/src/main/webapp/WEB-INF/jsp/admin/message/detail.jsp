...
<div class="pageContent">
	...
	<table class="list" width="100%" layoutH="91">
		<thead>
			<tr>
				<th style="font-weight: 900" width="20%">前置机ID</th>
				<th style="font-weight: 900" width="20%">地区部门名称</th>
				<th style="font-weight: 900" width="15%">发送状态</th>
				<th style="font-weight: 900" width="15%">发送时间</th>
			</tr>
		</thead>	
		<tbody>
			<c:forEach var="list" items="${pageList.result}" >
				...
				<td align="center"><fmt:formatDate value="${list.sendTime }" pattern="yyyy-MM-dd" /></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
