...
<div class="pageContent">
	<form method="post" action="${basePath }/admin/department/addAreaTow?areaInfo=${areaInfo}&areaId=${areaInfo.areaId}" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent nowrap" layoutH="58">
			<dl>
<%-- 			<input type="text" value="${areaInfo.areaId}"/> --%>
			...
			<dl>
				...
				<dd>
						<input type="text" name="areaCode" id="areaCode" onblur="checkAreaCode('${areaInfo.areaCode }');"
						<c:if test="${areaInfo!=null}">readonly="true"</c:if>
