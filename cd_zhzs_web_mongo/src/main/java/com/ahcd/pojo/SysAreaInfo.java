...
public class SysAreaInfo {
    ...
    private List<SysDepartmentInfo> departmentNameList;
	...
	public List<SysDepartmentInfo> getDepartmentNameList() {
		return departmentNameList;
	}

	public void setDepartmentNameList(List<SysDepartmentInfo> departmentNameList) {
