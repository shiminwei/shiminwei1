...
public class StringUtil {
	 ...
	 * 
	 * @author : feiyue yang
	 * @version ：201年4月1日 下午18:05:17
	 * @return
	 */
	 public static String fn2(String a){
		 try {
			 if(StringUtil.isChinese(a)){
				 ...
				 hanziList.add("一"); hanziList.add("二"); hanziList.add("三");hanziList.add("四");hanziList.add("五");
				 hanziList.add("六"); hanziList.add("七"); hanziList.add("八");hanziList.add("九");hanziList.add("十");
				 hanziList.add("十一"); hanziList.add("十二");
				List<String> aLaBoList = new ArrayList<String>();
				for (int i = 1; i <= 12; i++) {
					aLaBoList.add(String.valueOf(i));
				}
				Object[] aLaBo = aLaBoList.toArray();
				for (int k = 0; k < hanziList.size(); k++) {
					if (a.equals(String.valueOf(hanziList.get(k)))) {
						return (String) aLaBo[k];
					}
				}
			}
			 String a1[] = a.split("");
	...
	/**
	 * 
	 * 功能说明 :汉字月份转阿拉伯数字 如：九转十二转12
	 * 
	 * @author : feiyue yang
	 * @version ：201年4月1日 下午17:05:17
	 * @return
	 */
	 ...
	 * 
	 * @author : fei yang
	 * @version ：2016年10月21日 上午9:52:26
	 * @param oldstr
	 * @param str
	 * @return
	 */
	public static boolean isInclude(String oldstr, String str) {
	...
	/**
	 * 
	 * 功能说明 :获取服务器当前时间，格式为：yyyy-MM-dd HH:mm:ss
	 * 
	 * @author : fei yang
	 * @version ：2016年11月1日 下午5:38:17
	 * @return
	 */
	...
	* @return:
	...
	public static void main(String[] args) {
		...
		// System.out.println("去掉字符串中重复的子字符串：" + removeSameString("100 100
		// 9658"));
		...
		// 07340"));
		System.out.println(isInclude("con14555", "1425"));
