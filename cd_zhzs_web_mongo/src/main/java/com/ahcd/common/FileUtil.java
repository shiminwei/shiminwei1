   ...
   */
   ...
   /**
	 * 
	   * 功能说明    :获取Action 最大ID
	   * @author   : fei yang 
	   * @version ：2016年6月12日 下午5:04:31 
	   * @return
	   * @modify :tianyuzhu 增加非空判断;增加文件不存在判断
	 */
//	public static String getMaxId(String filePath,String childNode){
//		 File file=new File(filePath);
//		 String maxId="1";
//		 if(file.exists())
//		 {
...
//			 }else
//			 {
//					XMLNode[] Nodes = root.getAllChildNode(childNode);
//					if(Nodes==null)
//					{
//						return maxId;
//					}else
...
//							maxId=compare(maxId, Nodes[i].getAttributeValue("id"));
//							}
//						return maxId;
//					}
//			 }
...
//	}
			 ...
			 * 
			   * 功能说明    :比较大小 
			   * @author   : fei yang 
			   * @version ：2016年6月12日 下午4:52:34 
			   * @param oldStr
			   * @param str
			   * @modify :tianyuzhu 直接返回最大值
			 */
			public static String compare(String oldMaxId,String maxId){
				if (Integer.valueOf(maxId)>Integer.valueOf(oldMaxId)) {
					Integer max=Integer.valueOf(maxId)+1;
					return max.toString();
				}else{
					Integer oldMax=Integer.valueOf(oldMaxId)+1;
					return oldMax.toString();
				}
			}
