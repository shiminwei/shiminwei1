...
<div class="pageContent">
	...
	<form method="post"
		action="	${basePath}admin/datasource/saveOrUpdate?isType=${isType}"
		class="pageForm required-validate"
		onsubmit="return validateCallback(this, navTabAjaxDone)"
		modelAttribute="datasourceBean">
		<div class="pageFormContent nowrap" layoutH="97">
			...
			<dl>
				<dt>类型：</dt>
				<dd>
					<select name="type" style="width:152px;margin-left: -25px;">
			...
			<dl>
				<dt>描述：</dt>
				<dd>
					<textarea style="width:146px;" name="desc" rows=2 cols=20>${datasourceBean.desc}</textarea>
				</dd>
			</dl>
		</div>
		<div class="formBar">
