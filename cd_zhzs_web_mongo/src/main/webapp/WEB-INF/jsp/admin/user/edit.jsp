...
<!-- 				<dd> -->
<!-- 					<select style="width:107px" name="hasWeb1"> -->
<!-- 						<option> -->
<%-- 							<c:if test="${sysReportUserInfo.hasWeb == 1 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
<%-- 							&nbsp;&nbsp;&nbsp;&nbsp;<span>是</span></c:if> --%>
<%-- 							<c:if test="${sysReportUserInfo.hasWeb == 0 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
<%-- 							&nbsp;&nbsp;&nbsp;&nbsp;<span>否</span></c:if> --%>
<!-- 						</option> -->
<!-- 						<option> -->
<%-- 							<c:if test="${sysReportUserInfo.hasWeb == 1 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
...
<!-- 				<dd> -->
<!-- 					<select style="width:107px" name="hasReport1"> -->
<!-- 						<option style="margin-left: 50px"> -->
<%-- 							<c:if test="${sysReportUserInfo.hasReport == 1 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
<%-- 							&nbsp;&nbsp;&nbsp;&nbsp;<span>是</span></c:if> --%>
<%-- 							<c:if test="${sysReportUserInfo.hasReport == 0 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
<%-- 							&nbsp;&nbsp;&nbsp;&nbsp;<span>否</span></c:if> --%>
<!-- 						</option> -->
<!-- 						<option> -->
<%-- 							<c:if test="${sysReportUserInfo.hasReport == 1 }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --%>
