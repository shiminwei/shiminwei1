...
<div class="panelBar">
	<ul class="toolBar">
		...
		<li><a class="add" href="${basePath }web/companyinfo/toAddOrEdit" target="dialog" width="750" height="600" rel="addCompanyInfo"><span>新增</span></a></li>
		...
		<tbody>
			<c:forEach var="list" items="${pageList.result}" >
				...
				<td align="center" style="float:left;">				
					<a title="修改" target="dialog" width="750" height="600" style="color: blue"  
