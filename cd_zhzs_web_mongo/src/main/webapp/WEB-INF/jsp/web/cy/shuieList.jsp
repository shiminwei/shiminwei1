...
<form id="pagerForm" method="post"
	action="${basePath }web/cy/shuieList">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);"
		action="${basePath }web/cy/shuieList?startDate=${bean.startDate}&endDate=${bean.endDate}&nameCy=${bean.nameCy}&nameMl=${bean.nameMl}&nameDl=${bean.nameDl}"
		method="post">
		<div class="searchBar">
	...
	<table class="list" width="100%" layoutH="62">
		<thead>
			<tr>
				...
				<th align="center">征收项目</th>
				<th align="center">征收品目</th>
				<th align="center">实缴金额</th>
				<th align="center">入库日期</th>
				<th align="center">所属国地税</th>
			</tr>
							<tr>
