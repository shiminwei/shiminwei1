...
@Document(collection = "zhzs_excel_template")
public class ExcelTemplate {
	...
	private String fileType="excel";//上报文件类型
	private String templateFile;//上报文件名
	private String idcode="1111yyyyMMdd01";//文件编码
	private String datasource;
	private String tableName;
	private int start=1;
	private int end=0;
	private String delColName="k_del";
	private String kDateColName="k_create_date";
