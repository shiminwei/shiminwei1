...
function checklogin(){
	var loginform=document.loginform;
	  ...
	  // $.trim()取代原有的.trim()方法，兼容各浏览器    peixizhu 2017-03-10 17:05
	  loginform.loginCode.value =$.trim(loginform.loginCode.value); 
	  loginform.loginPwd.value =$.trim(loginform.loginPwd.value);   
	  loginform.submit();
}
function on_return(){
            ...
            <li class="topD">
                <ul class="login">
					<li><span class="left">平&nbsp;&nbsp;&nbsp;台：</span> <span style="left">
                        <select onchange="checkIt();" id="select"><option value="01">采集平台</option><option value="02">展现平台</option></select>
