...
$(function(){
	...
	if($("#divCurPage").html()==''){
		navTab.init();
		navTab.openTab('main','${basePath }/web/index',{title:'首页',fresh:true,data:{}});
	}
});
</script>
</head>
	...
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<c:if test="${ sessionScope.currentLogonUser.userCode eq 'admin' and sessionScope.currentLogonUser.userId eq 1}">
					<li><a href="${basePath }admin/index" target="_blank" >管理后台</a></li>
					</c:if>
					<li><a href="javascript:void(0)" onclick="gotoEditPwd()">修改密码</a></li>
					<li><a href="sidebar_2.html">帮助</a></li>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">	
						<ul class="tree treeFolder">
							<li><a href="${basePath }web/department/show" target="navTab" rel="departmentList">行政机构</a></li>
						</ul>
					</div>
					<div class="accordionHeader">
						<h2><span>Folder</span>数据报送	</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="${basePath }web/dataReport/list" target="navTab" rel="reportUpload">数据报送</a></li>
							<li><a href="${basePath }web/dataQuery/list" target="navTab" rel="dataQuery">数据查询</a></li>
						</ul>
					</div>
					<div class="accordionHeader">
						<h2><span>Folder</span>系统公告</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree">
							<li><a href="${basePath }web/notice/list" target="navTab" rel="noticeQuery">公告查询</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div id="container">
			<div id="navTab" class="tabsPage">
				...
				<div class="navTab-panel tabsPageContent layoutBox" style="height:685px;">
...
function gotoEditPwd(){
	$.pdialog.open("${basePath }web/user/toEditPwd","","", {title:"编辑部门信息",width:"720",height:"313",mask:true,fresh:true});
}
</script>
