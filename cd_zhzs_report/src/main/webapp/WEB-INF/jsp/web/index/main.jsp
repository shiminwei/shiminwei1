						...
						<tr>
							...
							<td align="center">
								<div style="margin: 0 auto; width: 46px;">
									<a class="button"
						onclick="show('${basePath }web/dataReport/toReport?reportType=1&reportPeroid=${list.zq}&templateName=${list.name}&reportPeroid=${list.zq}','报送')"><span>报送</span></a>
								</div>
							</td>
							<td align="center">
								<div style="margin: 0 auto; width: 46px;">
									<a class="button"
						onclick="show('${basePath }web/dataReport/toReport?reportType=2&reportPeroid=${list.zq}&templateName=${list.name}&reportPeroid=${list.zq}','重报')"><span>重报</span></a>
								</div>
							</td>
							<td align="center">
								<div style="margin: 0 auto; width: 46px;">
									<a class="button"
						onclick="show('${basePath }web/dataReport/toReport?reportType=3&reportPeroid=${list.zq}&templateName=${list.name}&reportPeroid=${list.zq}','补报')"><span>补报</span></a>
								</div>
							</td>
						</tr>
					</c:forEach>
