...
<div class="panelBar">
	<ul class="toolBar">
		...
		<li><a class="delete" href="${basePath }admin/template/delete?id={template_id}" target="ajaxTodo" title="确定要删除吗?" mask="true"><span>删除</span></a></li>
		<li><a class="edit" href="${basePath }admin/template/toAddOrEdit?_id={template_id}&type=2" target="navTab" mask="true"><span>修改</span></a></li>
	</ul>	
</div>
</form>
<div class="pageContent">
	<table class="table" width="100%" layoutH="113">
		...
		<tbody>
			...
			<tr target="template_id" rel="${item._id }">
