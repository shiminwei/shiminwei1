...
<div class="pageContent">
	...
	<form method="post" action="	${basePath}admin/datasourceConfig/${operateMethod}" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)"  modelAttribute="datasourceBean">
		<input type="hidden" name="id" value="${datasourceBean.id}"/>
			...
			<dl>
				...
				<dd>
					<select name="type">
						...
						<option value="sqlserver" <c:if test="${datasourceBean.type eq 'sqlserver'}"> selected="selected"</c:if>>sql server</option>
					</select>
				</dd>
			</dl>
			<dl>
