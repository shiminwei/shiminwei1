...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${basePath }admin/zdConstant/toSaveOrUpdate?istype=1" mask="true"
			...
			<c:forEach var="list" items="${pageList.result}" varStatus="status">
				<tr>
					...
					<td align="center"><a style="margin-left: 19%" title="子码表管理" target="navTab"
						...
						rel="chileList">子码表管理</a> <a style="margin-left: 25px" title="确定要删除该码表吗?" target="ajaxTodo"
