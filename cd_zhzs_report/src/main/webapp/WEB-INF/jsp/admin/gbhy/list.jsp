		...
		<div class="searchBar">
			<ul class="searchContent">
				<li><label>产业类型:</label> 
					...
					<option <c:if test="${ name_cy == '第一产业'}"> selected="selected" </c:if> value="第一产业">第一产业</option>
					<option <c:if test="${ name_cy == '第二产业'}"> selected="selected"</c:if> value="第二产业">第二产业</option>
					<option <c:if test="${ name_cy == '第三产业'}"> selected="selected"</c:if> value="第三产业">第三产业</option> 
				</select> </li>
