...
<div class="pageContent">
	...
	<form id="myFrom" method="post"
		action="${basePath}admin/webMenu/saveOrUpdate?menuLevel=${MenuLevel}"
		...
		<div class="pageFormContent nowrap" layoutH="97">
			<dl>
				<dt>菜单名称：</dt>
				<dd>
					<input type="text" id="district.functionName" maxlength="30"
						id="name" name="name" value="${bean.name }" class="required"
			...
			<dl>
				<dt>选择功能：</dt>
				<dd>
					<select id="mySelect" style="width: 207px" class="combox"
						onchange="toAddName()">
