...
<!--[if gte IE 9]><!--><script src="${basePath }static/js/jquery-2.1.4.js" type="text/javascript"></script><!--<![endif]-->
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">	
						<ul class="tree treeFolder">
							<li><a href="${basePath }admin/department/show" target="navTab" rel="departmentList">行政机构</a></li>
 							<li><a href="${basePath }web/modelShow/ceshiTable" target="navTab" rel="ceshiTable">测试固定表头</a></li>
