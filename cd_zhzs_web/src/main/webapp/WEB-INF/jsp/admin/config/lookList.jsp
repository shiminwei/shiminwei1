...
<form id="pagerForm" method="post"
	action="${basePath }admin/config/lookList">
	...
	<input type="hidden" name="id" value="${bean.functionId}" /> <input
...
<div class="pageHeader">
		...
		<div class="searchBar">
			<ul class="searchContent">
				<li><label>功能ID：</label> <input type="text" name="id"
	...
	<table class="table" width="100%" layoutH="118" targetType="dialog">
		...
		<tbody>
			...
			<c:forEach var="list" items="${pageList.result}" varStatus="status">
				<tr ondblclick="javascript:$.bringBack({'${reId}':'${list.functionId}','${reName}':'${list.name}'})" >
