...
<div class="panelBar" align="center" style="color:red">
	<h2 class="contentTitle" style="margin-right: 94%;margin-left: -2%">配置增改</h2>
</div>
...
<div class="pageContent">
	...
	<form id="myForm" method="post"
		...
		<div class="pageFormContent nowrap" layoutH="81">
			...
			<dl>
				<dt>制表单位：</dt>
				<dd>
					<select name="unitName" class="combox">
					<option value="">--请选择--</option>
					<option value="元" <c:if test="${bean.unitName=='元'}">selected="selected"</c:if>>元</option>		
					<option value="万元" <c:if test="${bean.unitName=='万元'}">selected="selected"</c:if>>万元</option>		
					</select>
				</dd>
			...
			<dl>
				<dt>查询方式：</dt>
				<dd>
					<select id="resultType" name="resultType" class="combox">
						<option value="SQL"
 ...
 --%>
			...
			<input type="hidden" name="type" value="${type }" /> <input
				type="hidden" name="functionId" value="${bean.functionId }" />
