...
<div class="pageFormContent nowrap" layouth="97" style="height: 500px;overflow: auto;">
	...
	<dl>
		...
		<dd style="width: 200px">
			<select name="type" style="width: 120px" disabled="true">
		...
		<dd style="width: 200px">
			<select name="addressType" style="width: 120px" disabled="true">
	...
	<dl>
		...
		<textarea name="address" rows="5" cols="80" tools="mini"  class="required" disabled="disabled">${bean.address }</textarea></dd>
	</dl>
</div>
