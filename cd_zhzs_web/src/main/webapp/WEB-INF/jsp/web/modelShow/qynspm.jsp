...
<form id="pagerForm" name="pagerForm" method="post"
	action="${basePath }web/modelShow/qynspm">
...
<form method="post" name="pagerForm"
	...
	<div class="pageHeader">	
		<div class="searchBar">
					<h1 align="center" style="font-size: 30px;margin-bottom: -12px">${year}年<c:if test="${month!=null&&month!=''}">${month}月</c:if>全市企业纳税排名情况表</h1>
	...
	<table class="list" width="100%" layoutH="121">
		<thead>
			<tr>
				...
				<th width="center" align="center" colspan="1" rowspan="4" style="font-size: 14px">所属区域</th>	
				<th width="center" align="center" colspan="1" rowspan="4" style="font-size: 14px">累计完成数</th>	
				<th width="center" align="center" colspan="1" rowspan="4"  style="font-size: 14px">纳税位次</th>	
				<th width="center" align="center" colspan="9" style="font-size: 14px">分征管部门</th>	
				<th width="center" align="center" colspan="3" rowspan="3" style="font-size: 14px">上年同期</th>	
