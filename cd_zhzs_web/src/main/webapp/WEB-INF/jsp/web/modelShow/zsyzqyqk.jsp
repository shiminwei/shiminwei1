...
<form id="pagerForm" name="pagerForm" method="post"
	action="${basePath }web/modelShow/zsyzqyqk">
...
<form method="post" name="pagerForm"
	...
	<div class="pageHeader">	
		<div class="searchBar">
					<h1 align="center" style="font-size: 30px;margin-bottom: -12px">${year}年<c:if test="${month!=null&&month!=''}">${month}月</c:if>全市招商引资企业纳税明细表</h1>
...
<div class="pageContent">
	<table class="list" width="100%" layoutH="121">
		<thead>
			<tr>
				<th width="center" align="center"  rowspan="3" style="font-size: 14px">序号</th>
				<th width="center" align="center"  rowspan="3" style="font-size: 14px">企业名称</th>
				<th width="center" align="center"  rowspan="3" style="font-size: 14px">收款国库</th>	
				<th width="center" align="center"  rowspan="3" style="font-size: 14px">累计完成数</th>	
