...
public class QuartzScheduleUtils {
	 ...
	 * @throws SchedulerException
	 */
	public Date scheduleJob(JobDetail jobDetail, String cronExpressionStr) throws SchedulerException {
		CronTrigger trigger = TriggerBuilder.newTrigger().withIdentity("cronTrigger", "cronTrigger")
				.withSchedule(CronScheduleBuilder.cronSchedule(cronExpressionStr)).build();
